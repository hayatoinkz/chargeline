...
export const addCarFormSchema = z.object({
  ...
  licensePlate: z
    .string({
      required_error: 'Você precisa digitar a placa',
    })
    .regex(licensePlateRegex, 'Digite uma placa válida'),
  type: z
...
export const defaultValues: Partial<AddCarFormValues> = {
  type: TypeCarStringEnum.FLEX,
  capacity: 35,
};
